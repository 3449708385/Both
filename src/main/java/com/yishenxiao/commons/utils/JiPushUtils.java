 ...
 */
@Component
public class JiPushUtils {

    private static final Logger LOGGER = LoggerFactory.getLogger(JiPushUtils.class);
    ...
    public JiPushUtils(){
    	this.appKey=PropertiesUtils.getInfoConfigProperties().getProperty("jipush.appKey");
    	this.masterSecret=PropertiesUtils.getInfoConfigProperties().getProperty("jipush.masterSecret");
